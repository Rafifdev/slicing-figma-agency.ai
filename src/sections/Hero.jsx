...
const Hero = () => {
  return (
    <section className="flex flex-col items-center gap-6 py-10 sm:py-20 c-space max-w-7xl mt-16 relative overflow-hidden sm:overflow-visible">
      <img src={assets.bgImage1} className="absolute -right-50 bottom-30 sm:-right-0 -z-1 dark:hidden"/>
      ...
      <h1 className="text-4xl sm:text-5xl md:text-[84px] text-center font-bold max-w-5xl md:leading-25 text-gray-700 dark:text-white mt-5 sm:mt-0">
      ...
      <img
        src={assets.hero_img}
        alt="hero image"
        className="w-[1100px] mt-5 sm:mt-10 hover-animation"
      />
    </section>
  );
};
